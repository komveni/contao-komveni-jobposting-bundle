...
namespace Komveni\ContaoKomveniJobpostingBundle\Controller\FrontendModule;
...
#[AsFrontendModule(category: 'jobposting_modules', template: 'mod_jobposting_listing')]
class JobpostingListingController extends AbstractFrontendModuleController
{
